...
/*
 ...
 The words in his note are case-insensitive and he must use only whole words available in the magazine.
 He cannot use substrings or concatenation to create the words he needs.
 Given the words in the magazine and the words in the ransom note, complete the checkMagazine function
 to return YES if he can replicate his ransom note exactly using whole words from the magazine; otherwise, return NO.
 For example, the note is "Attack At Dawn". The magazine contains only "attack at dawn".
 The magazine has all the right words and even if there's a case mismatch, the answer is YES.
 Another example, the note says "give two grand today" and the magazine contains "give me one grand today night".
 The magazine doesnt have all the right words, so the answer is NO.
*/
